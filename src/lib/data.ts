...
const generateDummyData = (): MarketingData[] => {
  ...
  for (let i = 0; i < TOTAL_WEEKS; i++) {
    ...
    data.push({
      ...
      distribution_score: 75 + Math.random() * 10,
  ...
  for (let i = 0; i < TOTAL_WEEKS; i++) {
    ...
    const baseline_sales = (20000 + i * 50) * seasonality_index;
    ...
    const media_contribution_total = media_contribution_search + media_contribution_social + media_contribution_display + media_contribution_video + media_contribution_affiliate;
